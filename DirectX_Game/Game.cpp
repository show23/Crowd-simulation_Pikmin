...
void Game::Init()
{
	...
	AddGameObject<Enemy>(1)->SetPosition(D3DXVECTOR3(-10.0f, 0.0f, 0.0f));
	...
	//BlueBullet
	/*AddGameObject<BluePikmin>(1)->SetPosition(D3DXVECTOR3(15, 0.0f, -20.0f));
	AddGameObject<BluePikmin>(1)->SetPosition(D3DXVECTOR3(20, 0.0f, -20.0f));
	AddGameObject<BluePikmin>(1)->SetPosition(D3DXVECTOR3(25, 0.0f, -20.0f));
	AddGameObject<BluePikmin>(1)->SetPosition(D3DXVECTOR3(30, 0.0f, -20.0f));*/
	...
	AddGameObject<Platform>(1)->SetPosition(D3DXVECTOR3(-10, 0, -10));
	//AddGameObject<Platform>(1)->SetPosition(D3DXVECTOR3(15, 0, 0));
	//AddGameObject<Platform>(1)->SetPosition(D3DXVECTOR3(20, 0, -10));

	AddGameObject<Dolphin>(1)->SetPosition(D3DXVECTOR3(5, 0, -10));
	//Platform* platform = AddGameObject<Platform>(1);
	//platform->SetPosition(D3DXVECTOR3(100.0f, 0.0f, 10.0f));
